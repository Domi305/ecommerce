...
public class ProductCategoryControllerTest {
    ...
    @Test
    public void listingAllProductsCategories() throws Exception {
    ...
    @Test
    public void addingNewSubProductCategory() throws Exception {

        CreateProductCategoryRequest request = new CreateProductCategoryRequest("Newborn clothes",fixture.childClothes().getId());
        String payload = objectMapper.writeValueAsString(request);
        mockMvc.perform(post("/products/categories")
                .contentType(MediaType.APPLICATION_JSON)
                .content(payload))
